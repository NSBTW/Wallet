...
namespace Wallet.Migrations
{
    ...
    [Migration("20201211103802_addedId")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WalletProject.Database.Models.AccountRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Commissions.CommissionRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.CurrencyRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.OperationRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");

                    b.Property<string>("CommissionRecordId")
                        .HasColumnType("text")
                        .HasColumnName("commission_record_id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.UserRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.WalletRecord", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WalletProject.Database.Models.UserRecord", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WalletProject.Database.Models.AccountRecord", b =>
                {
                    b.HasOne("WalletProject.Database.Models.UserRecord", "UserRecord")
                        .WithMany("Accounts")
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Commissions.CommissionRecord", b =>
                {
                    b.HasOne("WalletProject.Database.Models.CurrencyRecord", "CurrencyRecord")
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.OperationRecord", b =>
                {
                    b.HasOne("WalletProject.Database.Models.Commissions.CommissionRecord", "CommissionRecord")
                        .WithMany()
                        .HasForeignKey("CommissionRecordId")
                        .HasConstraintName("fk_operations_commissions_commission_record_id");

                    b.HasOne("WalletProject.Database.Models.WalletRecord", "TargetWalletRecord")
                        .WithMany()
                        .HasForeignKey("TargetWalletRecordId")
                        .HasConstraintName("fk_operations_wallets_target_wallet_record_id");

                    b.HasOne("WalletProject.Database.Models.WalletRecord", "WalletRecord")
                        .WithMany()
            ...
            modelBuilder.Entity("WalletProject.Database.Models.WalletRecord", b =>
                {
                    b.HasOne("WalletProject.Database.Models.AccountRecord", "AccountRecord")
                        .WithMany("Wallets")
