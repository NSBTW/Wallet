...
namespace Wallet.Migrations
{
    ...
    [Migration("20201207184650_OperationsIdRename")]
    partial class OperationsIdRename
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Account", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Commissions.Commission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Commissions.CommissionsStack", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Currency", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.Operation", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.PersonalCommission", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.WalletProject", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Commissions.AbsoluteCommission", b =>
                {
                    b.HasBaseType("WalletProject.Database.Models.Commissions.Commission");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Commissions.RelativeCommission", b =>
                {
                    b.HasBaseType("WalletProject.Database.Models.Commissions.Commission");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.DepositOperation", b =>
                {
                    b.HasBaseType("WalletProject.Database.Models.Operations.Operation");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.OutOperation", b =>
                {
                    b.HasBaseType("WalletProject.Database.Models.Operations.Operation");
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.TransferOperation", b =>
                {
                    b.HasBaseType("WalletProject.Database.Models.Operations.Operation");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WalletProject.Database.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Account", b =>
                {
                    b.HasOne("WalletProject.Database.Models.User", "User")
                        .WithMany("Accounts")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Commissions.CommissionsStack", b =>
                {
                    b.HasOne("WalletProject.Database.Models.Commissions.Commission", "DepositCommission")
                        .WithMany()
                        .HasForeignKey("DepositCommissionId")
                        .HasConstraintName("fk_commissions_stack_commissions_deposit_commission_id");

                    b.HasOne("WalletProject.Database.Models.Commissions.Commission", "OutCommission")
                        .WithMany()
                        .HasForeignKey("OutCommissionId")
                        .HasConstraintName("fk_commissions_stack_commissions_out_commission_id");

                    b.HasOne("WalletProject.Database.Models.Commissions.Commission", "TransferCommission")
                        .WithMany()
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Currency", b =>
                {
                    b.HasOne("WalletProject.Database.Models.Commissions.CommissionsStack", "CommissionsStack")
                        .WithMany()
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.Operation", b =>
                {
                    b.HasOne("WalletProject.Database.Models.WalletProject", "WalletProject")
                        .WithMany()
                        .HasForeignKey("WalletId")
                        .HasConstraintName("fk_operations_wallets_wallet_id");

                    b.Navigation("WalletProject");
                });
            ...
            modelBuilder.Entity("WalletProject.Database.Models.PersonalCommission", b =>
                {
                    ...
                    b.HasOne("WalletProject.Database.Models.Currency", "Currency")
                        .WithMany()
            ...
            modelBuilder.Entity("WalletProject.Database.Models.WalletProject", b =>
                {
                    b.HasOne("WalletProject.Database.Models.Account", "Account")
                        .WithMany("Wallets")
            ...
            modelBuilder.Entity("WalletProject.Database.Models.Operations.TransferOperation", b =>
                {
                    b.HasOne("WalletProject.Database.Models.WalletProject", "TargetWallet")
                        .WithMany()
